...
from app.kafkaProducer import KafkaProducer
...
async def register(user: userCreate):
    ...
    connection.commit()
    cur.close()
    kafka_producer.send_user_registered_event(userId)
...
async def login(user: userLogin):
    ...
    cur.close()
    return {"access_token": token, 'refresh_token': None, "user_id": userId}
